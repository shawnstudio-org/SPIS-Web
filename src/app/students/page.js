                  ...
                  <tr key={student.id}>
                    ...
                    <td>
                      <div className="btn-row">
                        ...
                        <Link className="secondary-btn" href={`/students/${student.id}/reports/new`}>New Report</Link>
                        <Link className="secondary-btn" href={`/students/${student.id}/reports`}>Reports</Link>
